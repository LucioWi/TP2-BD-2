...
public interface FraudeService {
    ...
    /** Cuentas que participan en al menos un ciclo de transferencias (lavado circular). */
    List<CuentaSelectDto> cuentasConCiclosActivos();

    /** Cuentas origen del patrón de smurfing hacia la mula c10. */
    List<CuentaSelectDto> cuentasOrigenSospechosas();

    /** Cuentas hub receptoras finales del flujo de fraude. */
    List<CuentaSelectDto> cuentasDestinoHubs();
}
